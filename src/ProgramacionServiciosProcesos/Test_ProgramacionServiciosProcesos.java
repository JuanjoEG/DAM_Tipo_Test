...
public class Test_ProgramacionServiciosProcesos {
    ...
    public static void main(String[] args) {
        ...
        ************************************************************************
            ...
            /*16*/      tipo_test("Si en Java queremos hacer que un trozo de código sea seguro para que lo puedan\n        utilizar varios procesos:", "Deberemos hacer que cada proceso se ejecute en orden.", "Deberemos poner la palabra synchronized y dentro el trozo de código.", "Deberemos poner la palabra sync y dentro el trozo de código.", "Deberemos poner la palabra syncronized y dentro el trozo de código.", "2");
            ...
            /*25*/      tipo_test("A la hora de crear hilos que se ejecutan concurrentemente, con el método join() ...", "Podemos unir la ejecución de hilos diferentes.", "Podemos hacer que una acción espere a que un hilo acabe.", "Unimos los flujos de entrada y de salida de los hilos.", "Conseguimos que todos los hilos terminen a la vez.", "3");
