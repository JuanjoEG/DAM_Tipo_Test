...
public class Test_Rep_II_Acc_Dat {
    ...
    public static void test_Repaso() {
           ...
           /*004*/      tipo_test("En un fichero de mapeo de Hibernate, el elemento <property> se usa para mapear ...", "El atributo único ID en la parte de la clase Java.", "La clave primaria.", "Los atributos o propiedades de Java.", "El nombre de la tabla en SQL.", "3");
           ...
           /*007*/      tipo_test("Según el tipo de almacenamiento, las bases de datos nativas XML pueden clasificarse en:", "2 tipos: basado en texto o basado en el modelo.", "2 tipos: almacenamiento en remoto o almacenamiento local.", "2 tipos: basado en el modelo, o almacenamiento local.", "3 tipos: basado en texto, basado en el modelo, o mediante almacenamiento local.", "4");
           ...
           /*014*/      tipo_test("Los tipos de módulos J2EE para aplicaciones web EJB son:", "Módulo .jar y módulo .war.", "Módulos EJB, módulo web, módulo de la aplicación cliente y módulo del adaptador de recursos.", "Módulo Web y módulo de la aplicación cliente.", "Módulo Web y módulo administrador.", "2");
           ...
           /*017*/      tipo_test("En MongoDB, la operación \"Create\" se realiza con:", "Append.", "Insert.", "Create.", "Add.", "2");
           ...
           /*027*/      tipo_test("Dos características comunes de las bases de datos No-SQL son:", "Modelo de datos relacional, y sin esquema (schemaless).", "Modelo de datos relacional, y con esquema (schemaless).", "Modelo de datos no relacional, y sin esquema (schemaless).", "Modelo de datos no relacional, y con esquema (schemaless).", "3");
           ...
           /*037*/      tipo_test("Es una ventaja en la utilización de las bases de datos orientadas a objetos.", "Es un modelo de datos universal.", "Mayor capacidad de modelado.", "No hace falta utilzar la encapsulación para realizar consultas.", "No tiene competencia.", "2");
           ...
           /*044*/      tipo_test("En los tipos compuestos de las bases de datos objeto relacionales,\n        se podrán crear funciones.", "Con código en otros lenguajes.", "Con código en otros lenguajes, excepto SQL.", "Con código en otros lenguajes, excepto Java.", "Con código en otros lenguajes, excepto C#.", "1");
           ...
           /*047*/      tipo_test("MongoDB es una base de datos NoSQL ...", "Orientada a Objetos.", "Orientada a Documentos.", "Falso: MongoDB es una base de datos relacional SQL.", "que solo se puede utilizar en entornos que no permitan la replicación.", "2");
           ...
           /*054*/      tipo_test("Una característica de los índices en MongoDB es que:", "Ofrece grandes mejoras en las operaciones de escritura", "Se almacenan en disco.", "Los operadores de negación utilizan índices.", "No sólo se indican los campos del índice, sino el orden del mismo.", "4");
           ...
           /*057*/      tipo_test("En Hibernate, el fichero de mapeo, indica ...", "El mapeo de la clase en la base de datos.", "El mapeo de los drivers de la base de datos.", "El mapeo de la conexión de la base de datos.", "Hibernate no utiliza ficheros de mapeo.", "1");
           ...
           /*064*/      tipo_test("En los tipos compuestos de las bases de datos objeto relacionales,\n        se podrán definir al menos dos métodos:", "Uno para convertir de este tipo a caracteres ASCII, y otro que haga esta función a la inversa.", "Uno para convertir de este tipo a objetos, y otro que haga esta función a la inversa.", "Uno para convertir de este tipo a punteros, y otro que haga esta función a la inversa.", "Uno para convertir de este tipo a relacional, y otro que haga esta función a la inversa.", "1");
           ...
           /*074*/      tipo_test("Relacionado con las APIs, los EndPoints ...", "Son las instrucciones de finalización de las APIs.", "Son las puertas de entrada al código back de la aplicación.", "Son las instrucciones para guardar el contenido en la base de datos.", "Son las instrucciones para cerrar las conexiones web.", "2");
           ...
           /*087*/      tipo_test("Según el teorema de CAP, podemos encontrar a MongoDB en el vértice:", "CA.", "AP.", "CP.", "PA.", "3");
           ...
           /*094*/      tipo_test("Relacionado con MongoDB, la aplicación visual Compass permite:", "Navegar entre los datos.", "Importar datos.", "Eliminar datos.", "Clasificar datos.", "2");
           ...
           /*097*/      tipo_test("Para que un componente acepte propiedades compartidas, ¿Qué métodos debe integrar?", "addPropertyChangeListene.", "removePropertyChangeListener.", "oldremove.", "addPropertyChangeListene y removePropertyChangeListener son correctas.", "4");
           /*098*/      tipo_test("En Hibernate, a las clases cuyos objetos serán almacenados en base de datos\n        las llamaremos ...", "Clases principales.", "Clases main.", "Clases persistentes.", "Clases privadas.", "3");
           ...
           /*104*/      tipo_test("Elige entre las opciones una de los objetivos que tendríamos después de crear un VARRAY:", "Definir la tipología de una columna de una tabla relacional.", "Crear listas de tablas.", "Definir un atributo.", "Todas son falsas.", "1");
