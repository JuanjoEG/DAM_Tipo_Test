...
public class Test_English {
        ...
        ************************************************************************
            ...
            /*08*/      tipo_test("Choose the right preposition to complete the sentence:\nI'm afraid Dr Peterson is away.\nShe will be back ... two weeks.", "At", "On", "In", "Until", "3");
            ...
            /*04*/      tipo_test("Choose the right option to complete the sentence:\nPeter is always losing things.\nNow, he can't find ... laptop!", "Her", "Its", "Him", "His", "4");
            ...
            /*09*/      tipo_test("I go swimming on Monday and Wednesday every week.\nThat means that ...", "I go swimming two times a week.", "I go swimming twice a week.", "None of the options is correct.", "Both options are correct.", "2");
            /*10*/      tipo_test("Which of the following adverbs is used to express that something happens frequently?", "Rarely", "Often", "Sometimes", "Occasionally", "2");
                    }
                    case "3" -> {
                        System.out.println("\nTEMA " + menu + "\n");
            ...
            /*02*/      tipo_test("Which of the following expressions is used to tell this time:\n1:30 pm", "Half past one in the morning", "Half past one in the afternoon", "Thirty minutes to one in the afternoon", "Thirty minutes to one in the morning", "2");
            /*03*/      tipo_test("Which of the following expressions is used to tell this time:\n9:40 am", "Twenty to ten in the morning", "Twenty to ten in the afternoon", "Twenty past ten in the morning", "Twenty past ten in the afternoon", "1");
            ...
            /*02*/      tipo_test("Choose the right option to complete the sentence:\nHold on a minute, please.\nI'll ... Mr Smith.", "Hang on you", "Put you through", "Put you through to", "Hang up", "3");
